        ...
        <div className="w-full max-w-4xl">
          ...
          <section className="bg-gray-800 rounded-lg shadow-2xl p-8">
            ...
            <div className="flex flex-wrap gap-3 min-h-[40px]">
              {filteredSkills.length > 0 ? (
                ...
                filteredSkills.map((skill) => (
                  <span
                    key={skill}
                    className="bg-blue-500/20 text-blue-200 border border-blue-500/30 text-sm font-medium px-4 py-1.5 rounded-lg"
                  >
                    {skill}
                  </span>
                ))
            ...
            <footer className="flex flex-col sm:flex-row justify-end items-center gap-4">
              <Link href="/JobRoleSelection" className="flex items-center justify-center gap-2 bg-gray-700 hover:bg-gray-600 text-white font-medium py-2.5 px-5 rounded-lg transition-colors duration-200 w-full sm:w-auto">
                <FaUpload />
                <span>Upload New Resume</span>
              </Link>
              <Link href="/Report" className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-5 rounded-lg transition-colors duration-200 w-full sm:w-auto">
